...
using AvaloniaApplicationSample.Enums;
    ...
    public class QuestionBoxViewModel : ViewModelBase, IDisposable, ICloseable<QuestionBoxResult>
    {
        ...
        public void TrySetDefaultResult()
        {
            ...
            if (!_tcs.Task.IsCompleted)
            {
                ...
                Debug.WriteLine($"The TrySetResult method is complete for {nameof(QuestionBoxViewModel)}.");
            }
        }
        ...
        public void Dispose()
        {
            ...
            _isDisposed = true;
            Debug.WriteLine($"The Dispose method is complete for {nameof(QuestionBoxViewModel)}, Guid {Uid}.");
        }
    }
}
