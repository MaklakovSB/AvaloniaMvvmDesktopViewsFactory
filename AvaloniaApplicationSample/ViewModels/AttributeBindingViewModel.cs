...
{
    public class AttributeBindingViewModel : ViewModelBase, IDisposable
    {
        ...
        public void Dispose()
        {
            ...
            _isDisposed = true;
            Debug.WriteLine($"The Dispose method is complete for {nameof(AttributeBindingViewModel)}, Guid {Uid}.");
        }
    }
}
